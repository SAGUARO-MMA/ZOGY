...
# full output image
subimage_size = 880      # size of subimages
subimage_border = 50     # border around subimage to avoid edge effects
...
psf_sampling = 0.0       # PSF sampling step in image pixels used in PSFex
                         ...
                         # step in both images.
psf_samp_fwhmfrac = 1/2.5 # PSF sampling step in units of FWHM
                         # this is only used if [psf_sampling]=0.
size_vignet_ref = 25     # size of the square VIGNETs saved in the SExtractor
...
apphot_radii = [0.66, 1.5, 2.5] # list of radii in units of FWHM
...
obs_lat = 32.4168      # observatory latitude in degrees (North)
obs_long = -110.7326      # observatory longitude in degrees (East)
obs_height = 2518.       # observatory height in meters above sealevel
